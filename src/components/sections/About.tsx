...
export default function About() {
  return (
    ...
    >
      {/* Ruled notebook lines — bottom right */}
      ...
      <div className="wrap">
        ...
        {/* Desktop: overlapping cluster layout */}
        <div className="photos-desktop" style={{
          display: "flex",
          alignItems: "flex-end",
          ...
          {/* PHOTO 3 — small polaroid, top-left, washi tape */}
          <div style={{
            position: "absolute",
            top: "-50px",
            ...
            <div aria-hidden="true" style={{
              ...
              width: "clamp(50px, 7vw, 72px)", height: "18px",
              background: "rgba(107,117,96,0.38)", borderRadius: "2px", zIndex: 10,
          ...
          <div style={{ position: "relative", zIndex: 2 }}>
            ...
            <div className="photo-frame" style={{
              ...
              <div style={{
                ...
                <svg width="44" height="54" viewBox="0 0 44 54" fill="none" style={{ opacity: 0.22 }}>
          ...
          <div style={{ position: "relative", zIndex: 3 }}>
            ...
            <div style={{
              ...
              transform: "translateX(-50%) rotate(8deg)", zIndex: 10,
            ...
            <div className="photo-frame" style={{
              ...
              <div style={{
                ...
                <svg width="36" height="44" viewBox="0 0 44 54" fill="none" style={{ opacity: 0.22 }}>
                  <ellipse cx="22" cy="16" rx="12" ry="14" fill="rgba(28,28,26,0.8)" />
                  <path d="M2 52c0-11 9-20 20-20s20 9 20 20" stroke="rgba(28,28,26,0.8)" strokeWidth="1.5" fill="none" />
                </svg>
                <span style={{ fontFamily: "var(--font-sans)", fontSize: "10px", letterSpacing: "0.1em", color: "rgba(28,28,26,0.28)", textTransform: "uppercase" }}>Photo</span>
        ...
        {/* MOBILE photo layout — stacked horizontally, clean */}
        <div className="photos-mobile" style={{ display: "none" }}>
          <div style={{ display: "flex", gap: "20px", justifyContent: "center", alignItems: "flex-end", flexWrap: "wrap" }}>
            ...
            <div style={{ position: "relative" }}>
              <div style={{
                ...
                <svg width="20" height="32" viewBox="0 0 26 42" fill="none">
                  <ellipse cx="13" cy="21" rx="6.5" ry="1.8" fill="rgba(0,0,0,0.16)" />
                  <path d="M 12.5 19 L 12.5 40 Q 13 42 13.5 40 L 13.5 19 Z" fill="#8A7355" opacity="0.85" />
                  <circle cx="13" cy="11" r="10" fill="#8A7355" />
                  <ellipse cx="10" cy="7.5" rx="4.5" ry="3.2" fill="rgba(255,255,255,0.28)" />
              ...
              <div className="photo-frame" style={{ width: "140px", height: "180px", transform: "rotate(-3deg)", borderRadius: "4px" }}>
                <div style={{ width: "100%", height: "100%", background: "linear-gradient(160deg, #c8c4b8 0%, #b0ad9d 100%)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "6px" }}>
                  <svg width="32" height="38" viewBox="0 0 44 54" fill="none" style={{ opacity: 0.22 }}>
                    <ellipse cx="22" cy="16" rx="12" ry="14" fill="rgba(28,28,26,0.8)" />
                    <path d="M2 52c0-11 9-20 20-20s20 9 20 20" stroke="rgba(28,28,26,0.8)" strokeWidth="1.5" fill="none" />
                  </svg>
                  <span style={{ fontFamily: "var(--font-sans)", fontSize: "9px", letterSpacing: "0.1em", color: "rgba(28,28,26,0.28)", textTransform: "uppercase" }}>Photo</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ position: "relative" }}>
              <div style={{
                ...
                transform: "translateX(-50%) rotate(6deg)", zIndex: 10,
                filter: "drop-shadow(0 3px 6px rgba(0,0,0,0.22))",
              }}>
                <svg width="16" height="26" viewBox="0 0 20 34" fill="none">
                  <ellipse cx="10" cy="17" rx="5" ry="1.4" fill="rgba(0,0,0,0.14)" />
                  <path d="M 9.5 15 L 9.5 32 Q 10 34 10.5 32 L 10.5 15 Z" fill="#9B5F44" opacity="0.8" />
                  <circle cx="10" cy="9" r="8" fill="#9B5F44" />
                  <ellipse cx="7.5" cy="6.5" rx="3.5" ry="2.5" fill="rgba(255,255,255,0.24)" />
              ...
              <div className="photo-frame" style={{ width: "115px", height: "145px", transform: "rotate(4deg)", borderRadius: "3px" }}>
                <div style={{ width: "100%", height: "100%", background: "linear-gradient(160deg, #bfbcb2 0%, #a8a598 100%)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "5px" }}>
                  <svg width="28" height="34" viewBox="0 0 44 54" fill="none" style={{ opacity: 0.22 }}>
                    <ellipse cx="22" cy="16" rx="12" ry="14" fill="rgba(28,28,26,0.8)" />
                    <path d="M2 52c0-11 9-20 20-20s20 9 20 20" stroke="rgba(28,28,26,0.8)" strokeWidth="1.5" fill="none" />
                  </svg>
                  <span style={{ fontFamily: "var(--font-sans)", fontSize: "8px", letterSpacing: "0.1em", color: "rgba(28,28,26,0.28)", textTransform: "uppercase" }}>Photo</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <style jsx>{`
        @media (max-width: 768px) {
          ...
          .photos-desktop { display: none !important; }
          .photos-mobile { display: block !important; margin-top: 40px; }
          .about-spinner { display: none !important; }
        }
